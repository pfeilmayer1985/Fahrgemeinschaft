...
namespace TecAlliance.Carpool.Data.Models
{
    public class CarpoolsModelDto
    {
        ...
        public CarpoolsModelDto(int carpoolID, int driverID, int freeSeatsRemaining, string origin, string destination, DateOnly departureDate, TimeOnly departureTime)
        {
            CarpoolID = carpoolID;
            DriverID = driverID;
