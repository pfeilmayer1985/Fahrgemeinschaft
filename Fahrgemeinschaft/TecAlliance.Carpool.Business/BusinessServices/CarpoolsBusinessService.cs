...
namespace TecAlliance.Carpool.Business
{
    ...
    {
        private ICarpoolsDataServiceSQL _carpoolsDataService;
        private IUsersDataServiceSQL _usersDataService;
        List<CarpooslModelData> carpoolsList;
        ...
        {
            _carpoolsDataService = carpoolDataServiceSQL;
            _usersDataService = userDataServiceSQL;
        }
        ...
        /// </summary>
        public List<CarpooslModelData> ListAllCarpoolsBusinessService()
        {
            carpoolsList = _carpoolsDataService.ListAllCarpoolsDataService();
            return carpoolsList;
